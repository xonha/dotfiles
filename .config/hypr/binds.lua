...
hl.bind("SUPER+I", hl.dsp.exec_cmd(noct .. "panel-toggle yuuto/calculator:panel"))
hl.bind("SUPER+U", hl.dsp.exec_cmd(noct .. "panel-toggle noctalia/notes:panel"))
...
hl.bind("SUPER+Y", hl.dsp.exec_cmd(S.keyd .. " --toggle"))
hl.bind("SUPER+N", hl.dsp.exec_cmd(S.denoise .. " toggle"))
hl.bind("SUPER+O", hl.dsp.exec_cmd(noct .. "panel-toggle kenn/keybind-cheatsheet:cheatsheet"))
