...
| Versioned Compose | `.config/immich/docker-compose.yml` in this repository |
...
O arquivo versionado em `.config/immich/docker-compose.yml` é baseado no
...
scp .config/immich/docker-compose.yml bazzite:/var/home/henrique/immich/docker-compose.yml
