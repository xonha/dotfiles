...
Panel {
  id: root
  moduleName: "xonha.speech-to-text"
  ipcTarget: "xonha.speech-to-text"
  manageIpc: false

  readonly property var svc: bar && bar.shell ? bar.shell.serviceFor("xonha.speech-to-text") : null
  ...
  IpcHandler {
    ...
    // omarchy-shell xonha.speech-to-text dictate  (same as `stt toggle`)
