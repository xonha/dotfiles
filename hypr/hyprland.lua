...
-- Browser app windows (bindings.lua: WhatsApp, Todoist, YouTube Music,
-- Mais Todos in Chrome, Devbot in Edge)
...
o.window("^(brave-(origin-.+|.+-Default)|google-chrome(-maistodos)?|microsoft-edge-devbot)$", {
