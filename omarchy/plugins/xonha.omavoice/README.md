...
less ~/.config/omarchy/plugins/xonha.omavoice/README.md
omarchy plugin enable xonha.omavoice --section right
```
...
```sh
omarchy plugin update xonha.omavoice
omarchy plugin remove xonha.omavoice
```
